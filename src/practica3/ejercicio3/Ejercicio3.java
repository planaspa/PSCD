 ...
 * de bloqueo a nivel de datos de persona. Es decir, el acceso a la información
 * de cada persona se realiza en exclusión mutua. Sin embargo dos o más procesos
 * distintos pueden modificar datos de diferentes personas de forma concurrente.
 */
public class Ejercicio3 {
	...
	public static void main(String[] args) {
		...
		Semaphore [] mutex_vector = new Semaphore [100];
